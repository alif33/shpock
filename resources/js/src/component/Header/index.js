            ...
            <div className='d-flex'>
              <Nav className='align-items-center  d-flex sell-now'>
                ...
                <NavItem className='hearIcon'>
                  ...
                  >
                    <svg viewBox='0 0 24 24' className='SVG-wlnxuy-0 bIwcGB'>
                      <path
                ...
                <NavItem className='SearchIcon'>
                  ...
                  >
                    <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10.0625 18.6875C14.826 18.6875 18.6875 14.826 18.6875 10.0625C18.6875 5.29904 14.826 1.4375 10.0625 1.4375C5.29904 1.4375 1.4375 5.29904 1.4375 10.0625C1.4375 14.826 5.29904 18.6875 10.0625 18.6875Z" stroke="#7587A4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M16.5312 16.5312L21.5625 21.5625" stroke="#7587A4" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
...

              {
                users.isUser?(
                  ...
                  <>
                  <li className='signup'>
                    <Button onClick={ () => dispatch(attemptToSignup()) }>Sign Up</Button>
                  </li>
                  <li className='login'>
                    <Button onClick={ () => dispatch(attemptToLogin()) }>Log In</Button>
                  </li>
                </>
                )
              }
